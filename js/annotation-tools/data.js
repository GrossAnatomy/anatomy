...
// Scale-bar sizing and drawing moved to js/export/scalebar.js in v1.4.0, where
// a single I-beam definition now serves screenshots, the six-view plate and the
// PDF report. showScalebarConfirm() above stays here: it is a dialog, not
// geometry.
